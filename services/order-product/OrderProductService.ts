...
export const chunk = async (data, chunkSize = 100): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/chunk`, {
      data,
      chunkSize,
    });
...
export const each = async (callback): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/each`, {
...
export const firstOrCreate = async (
  ...
  try {
    const response = await axiosInstance.post(
      `order-products/first-or-create`,
      {
        searchCriteria,
        values,
      },
...
export const firstOrNew = async (
  ...
  try {
    const response = await axiosInstance.post(`order-products/first-or-new`, {
      data,
      callback: callback?.toString(),
      chunkSize,
    });
...
export const getWithRelations = async (relations = []): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(
      `order-products/get-with-relations`,
      {
        params: { relations },
      },
    );
...
export const pluck = async (column, key = null): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/pluck`, {
      params: { column, key },
    });
    return response.data;
  } catch (error) {
...
export const whereBetween = async (column, min, max): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/where-between`, {
      column,
      min,
      max,
    });
...
export const whereIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/where-in`, {
      column,
      values,
    });
    return response.data;
...
export const whereNotIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/where-not-in`, {
      column,
      values,
    });
    return response.data;
...
export const batchCreateWithTransaction = async (data, options) => {
  try {
    return axiosInstance.post('/order-products/batch-create', {
      dataArray: data,
      options: options,
    });
  } catch (error) {
...
export const batchUpdate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/batch-update`, {
      records,
    });
    return response.data;
  } catch (error) {
...
export const updateOrCreate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(
      `order-products/update-or-create`,
      {
        records,
      },
    );
...
export const create = async (data): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products`, data);
    return response.data;
  } catch (error) {
...
export const destroy = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.delete(`order-products/${id}`);
    return response.data;
  } catch (error) {
...
export const findById = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/${id}`);
    return response.data;
  } catch (error) {
...
export const index = async (params = {}): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products`, { params });
    return response.data;
  } catch (error) {
...
export const update = async (id, data): Promise<unknown> => {
  try {
    const response = await axiosInstance.put(`order-products/${id}`, data);
    return response.data;
  } catch (error) {
...
export const count = async (data = {}): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/count`, {
...
export const exists = async (params): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/exists`, {
      params,
    });
    return response.data;
  } catch (error) {
...
export const findByAttributes = async (attributes): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(
      `order-products/find-by-attributes`,
      {
        attributes,
      },
    );
...
export const paginate = async (
  ...
  try {
    const response = await axiosInstance.get(`order-products/paginate`, {
...
export const search = async (query, options = {}): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/search`, {
...
export const findMany = async (ids): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/find-many`, {
      ids,
    });
    return response.data;
  } catch (error) {
...
export const findOrFail = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(
      `order-products/find-or-fail/${id}`,
    );
    return response.data;
  } catch (error) {
...
export const groupBy = async (column): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/group-by`, {
      params: { column },
    });
    return response.data;
  } catch (error) {
...
export const latest = async (column, limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/latest`, {
      params: { column, limit },
    });
    return response.data;
  } catch (error) {
...
export const oldest = async (column, limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/oldest`, {
      params: { column, limit },
    });
    return response.data;
  } catch (error) {
...
export const orderBy = async (column, direction = 'asc'): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/order-by`, {
...
export const random = async (limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/random`, {
      params: { limit },
    });
    return response.data;
  } catch (error) {
...
export const onlyTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/only-trashed`);
    return response.data;
  } catch (error) {
...
export const restore = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`order-products/${id}/restore`);
    return response.data;
  } catch (error) {
...
export const softDelete = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.delete(`order-products/${id}/soft`);
    return response.data;
  } catch (error) {
...
export const withoutTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/without-trashed`);
    return response.data;
  } catch (error) {
...
export const withTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`order-products/with-trashed`);
    return response.data;
  } catch (error) {
