...
export const chunk = async (data, chunkSize = 100): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/chunk`, {
      data,
      chunkSize,
    });
...
export const each = async (callback): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/each`, {
...
export const firstOrCreate = async (
  ...
  try {
    const response = await axiosInstance.post(`users/first-or-create`, {
      searchCriteria,
      values,
    });
    return response.data;
...
export const firstOrNew = async (
  ...
  try {
    const response = await axiosInstance.post(`users/first-or-new`, {
      data,
      callback: callback?.toString(),
      chunkSize,
    });
...
export const getWithRelations = async (relations = []): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/get-with-relations`, {
      params: { relations },
    });
    return response.data;
  } catch (error) {
...
export const pluck = async (column, key = null): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/pluck`, {
      params: { column, key },
    });
    return response.data;
  } catch (error) {
...
export const whereBetween = async (column, min, max): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/where-between`, {
      column,
      min,
      max,
    });
...
export const whereIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/where-in`, {
      column,
      values,
    });
    return response.data;
...
export const whereNotIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/where-not-in`, {
      column,
      values,
    });
    return response.data;
...
export const batchCreateWithTransaction = async (data, options) => {
  try {
    return axiosInstance.post('/users/batch-create', {
      dataArray: data,
      options: options,
    });
  } catch (error) {
...
export const batchUpdate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/batch-update`, {
      records,
    });
    return response.data;
  } catch (error) {
...
export const updateOrCreate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/update-or-create`, {
      records,
    });
    return response.data;
  } catch (error) {
...
export const exists = async (params): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/exists`, { params });
    return response.data;
  } catch (error) {
...
export const findByAttributes = async (attributes): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/find-by-attributes`, {
      attributes,
    });
    return response.data;
  } catch (error) {
...
export const paginate = async (
  ...
  try {
    const response = await axiosInstance.get(`users/paginate`, {
...
export const findMany = async (ids): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`users/find-many`, {
      ids,
    });
    return response.data;
  } catch (error) {
...
export const findOrFail = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/find-or-fail/${id}`);
    return response.data;
  } catch (error) {
...
export const groupBy = async (column): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/group-by`, {
      params: { column },
    });
    return response.data;
  } catch (error) {
...
export const oldest = async (column, limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/oldest`, {
      params: { column, limit },
    });
    return response.data;
  } catch (error) {
...
export const orderBy = async (column, direction = 'asc'): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/order-by`, {
...
export const onlyTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/only-trashed`);
    return response.data;
  } catch (error) {
...
export const softDelete = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.delete(`users/${id}/soft`);
    return response.data;
  } catch (error) {
...
export const withoutTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/without-trashed`);
    return response.data;
  } catch (error) {
...
export const withTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`users/with-trashed`);
    return response.data;
  } catch (error) {
