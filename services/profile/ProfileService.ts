...
export const chunk = async (data, chunkSize = 100): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/chunk`, {
      data,
      chunkSize,
    });
...
export const each = async (callback): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/each`, {
...
export const firstOrCreate = async (
  ...
  try {
    const response = await axiosInstance.post(`profiles/first-or-create`, {
      searchCriteria,
      values,
    });
    return response.data;
...
export const firstOrNew = async (
  ...
  try {
    const response = await axiosInstance.post(`profiles/first-or-new`, {
      data,
      callback: callback?.toString(),
      chunkSize,
    });
...
export const getWithRelations = async (relations = []): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/get-with-relations`, {
      params: { relations },
    });
    return response.data;
  } catch (error) {
...
export const pluck = async (column, key = null): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/pluck`, {
      params: { column, key },
    });
    return response.data;
  } catch (error) {
...
export const whereBetween = async (column, min, max): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/where-between`, {
      column,
      min,
      max,
    });
...
export const whereIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/where-in`, {
      column,
      values,
    });
    return response.data;
...
export const whereNotIn = async (column, values): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/where-not-in`, {
      column,
      values,
    });
    return response.data;
...
export const batchCreateWithTransaction = async (data, options) => {
  try {
    return axiosInstance.post('/profiles/batch-create', {
      dataArray: data,
      options: options,
    });
  } catch (error) {
...
export const batchUpdate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/batch-update`, {
      records,
    });
    return response.data;
  } catch (error) {
...
export const updateOrCreate = async (records): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/update-or-create`, {
      records,
    });
    return response.data;
  } catch (error) {
...
export const exists = async (params): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/exists`, { params });
    return response.data;
  } catch (error) {
...
export const findByAttributes = async (attributes): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/find-by-attributes`, {
      attributes,
    });
    return response.data;
  } catch (error) {
...
export const paginate = async (
  ...
  try {
    const response = await axiosInstance.get(`profiles/paginate`, {
...
export const findMany = async (ids): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/find-many`, {
      ids,
    });
    return response.data;
  } catch (error) {
...
export const findOrFail = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/find-or-fail/${id}`);
    return response.data;
  } catch (error) {
...
export const groupBy = async (column): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/group-by`, {
      params: { column },
    });
    return response.data;
  } catch (error) {
...
export const latest = async (column, limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/latest`, {
      params: { column, limit },
    });
    return response.data;
  } catch (error) {
...
export const oldest = async (column, limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/oldest`, {
      params: { column, limit },
    });
    return response.data;
  } catch (error) {
...
export const orderBy = async (column, direction = 'asc'): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/order-by`, {
...
export const random = async (limit = 1): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/random`, {
      params: { limit },
    });
    return response.data;
  } catch (error) {
...
export const onlyTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/only-trashed`);
    return response.data;
  } catch (error) {
...
export const restore = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.post(`profiles/${id}/restore`);
    return response.data;
  } catch (error) {
...
export const softDelete = async (id): Promise<unknown> => {
  try {
    const response = await axiosInstance.delete(`profiles/${id}/soft`);
    return response.data;
  } catch (error) {
...
export const withoutTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/without-trashed`);
    return response.data;
  } catch (error) {
...
export const withTrashed = async (): Promise<unknown> => {
  try {
    const response = await axiosInstance.get(`profiles/with-trashed`);
    return response.data;
  } catch (error) {
